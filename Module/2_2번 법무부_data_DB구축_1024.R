...
#데이터 디렉토리 구축하기
#dir.create("data") #data 파일 생성

#DB 환경 설정
con <- dbConnect(SQLite(), "data/data_justice.sqlite")
...
#정제 완료 농업경영체 등록정보
dbWriteTable(con,'Regit_Info',Regit_Inf)
...
#정제 완료 허용작물별 품목 분류
dbWriteTable(con,'P_Regit_Inf',P_Regit_Inf)
...
#정제 완료 계절근로자 신청현황
dbWriteTable(con,'finaldata',final_dataset)
